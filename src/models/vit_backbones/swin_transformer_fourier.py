...
class BasicLayer(nn.Module):
    ...
    def __init__(self, dim, input_resolution, depth, num_heads, window_size,
                 ...
                 num_prompts=None, prompt_location=None, deep_prompt=None, FT=None, fourier_num_tokens=None
        ):
        ...
        self.FT = FT
        self.fourier_num_tokens = fourier_num_tokens
            ...
            if deep_prompt_embd.shape[0] != num_blocks:
                ...
                for i in range(num_blocks):
                    if i == 0:
                        ...
                        if self.fourier_num_tokens !=  self.num_prompts:
                            deep_prompt_emb = deep_prompt_embd[i-1][self.fourier_num_tokens:].expand(B, -1, -1)
                    
                        deep_prompt_fourier_emb = deep_prompt_embd[i-1][:self.fourier_num_tokens].expand(B, -1, -1)
                ...
                for i in range(num_blocks):
                    if self.fourier_num_tokens !=  self.num_prompts:
                        deep_prompt_emb = deep_prompt_embd[i][self.fourier_num_tokens:].expand(B, -1, -1)
                    
                    deep_prompt_fourier_emb = deep_prompt_embd[i][:self.fourier_num_tokens].expand(B, -1, -1)
