...
class PromptedTransformer_Fourier(Transformer):
    ...
    def incorporate_prompt(self, x):
        ...
        if self.prompt_config.FOURIER_FIRST_LAYER and self.prompt_config.FOURIER_PERCENTAGE != 0.0:
...
class PromptedVisionTransformer_Fourier_Mixed(VisionTransformer):
    def __init__(
        self, prompt_cfg, model_type,
        img_size=224, num_classes=21843, vis=False
    ):
        assert prompt_cfg.VIT_POOL_TYPE == "original"
        super(PromptedVisionTransformer_Fourier_Mixed, self).__init__(
    ...
    def forward(self, x, vis=False):
        ...
        # import json
        # json_path = '/home/ch7858/rz/vpt/temporary/fourier.json'
        ...
        # plot_6x12(attn_weights, '/home/ch7858/rz/vpt/temporary/fourier_100')
