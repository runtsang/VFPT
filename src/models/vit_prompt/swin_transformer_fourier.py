...
from ..vit_backbones.swin_transformer_fourier import (
...
class PromptedSwinTransformer_fourier(SwinTransformer):
    def __init__(
        ...
        super(PromptedSwinTransformer_fourier, self).__init__(
        ...
        for i_layer in range(self.num_layers):
            layer = BasicLayer(
                ...
                FT = self.FT,
                fourier_num_tokens = self.fourier_num_tokens
            )
    ...
    def load_state_dict(self, state_dict, strict):
        ...
        super(PromptedSwinTransformer_fourier, self).load_state_dict(state_dict, strict)
