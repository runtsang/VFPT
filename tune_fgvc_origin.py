...
def prompt_cars(args):
    lr_range = [
        5.0, 2.5, 10.0
    ]
    wd_range = [0.01, 0.001, 0.0001]
    for lr in lr_range:
        for wd in wd_range:
            # set up cfg and args
            try:
...
def main(args):
    ...
    if args.train_type == "finetune":
        ...
        prompt_main(args)
    elif args.train_type == "prompt_cars":
        prompt_cars(args)
    elif args.train_type == "prompt_cub":
        prompt_cub(args)
    elif args.train_type == "prompt_dog":
        prompt_dog(args)
    elif args.train_type == "prompt_flowers":
        prompt_flowers(args)
    elif args.train_type == "prompt_nabirds":
        prompt_nabirds(args)
